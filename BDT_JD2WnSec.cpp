...
//调用本函数的函数清单：无
///////////////////////////////////////////////////////////////////////////////////////////
int BDT_WnSec2JD(int WN,double Sec,double *JD)
{
	if(WN<0)
	{
		return 0;
	...
	else
	{
		...
		{
			//BDT的起始时间是2006年1月1号
			UTCTime timeof2006(2006,1,1,0,0,0.0,0.1);
			CAL2UTC(&timeof2006,1);

			UTCTime CurTime;
			CurTime.JD=timeof2006.JD+WN*7+Sec/86400.0;

			CurTime.IntJD=long(CurTime.JD);
			CurTime.DouJD=CurTime.JD-CurTime.IntJD;

			CAL2UTC(&CurTime,2);
			//北斗时的起始儒略日为2453736.5
			if(CurTime.JD<(2453736.5-10e-8))
			{
				return 0;
			}
			else
...
//调用本函数的函数清单：无
///////////////////////////////////////////////////////////////////////////////////////////
int BDT_JD2WnSec(double JD,int *WN,double *Sec)	
{
	//BDT的起始时间是2006年1月1号
	UTCTime timeof2006(2006,1,1,0,0,0.0,0.1);
	CAL2UTC(&timeof2006,1);
	double delt_JD=JD-timeof2006.JD;
